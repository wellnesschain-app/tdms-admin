...
<script>
    layui.use(['laydate','element','laypage','layer'], function(){
        ...
        function getMemberList(curr) {
            ...
            $.ajax({
                ...
                type:"GET",
                data:{"pageNum":curr,"pageSize":10,"status":status},
                dataType:"json",
                        ...
                        if(res.audits.list.length<=0){
                           ...
                           /* tr+='<tr><td>'+v.id+'</td>'+
                                ...
                                tr+=' <tr><td><input type="checkbox" value="'+v.id+'" name="">' + ' </td>' +
                                    ...
                                    '<td>' + type +'</td>' +
                                    '<td><a onclick="adopt('+v.id+')" style="cursor:pointer;">通过</a>&nbsp|&nbsp<a onclick="reject('+v.id+',\''+v.fromAddr+'\')" style="cursor:pointer;">驳回</a></td></tr>'
    ...
    function search() {
        ...
        window.location.href="${ctx}/admin/audit/auditSearch?id="+id+"&status="+status;
    }
