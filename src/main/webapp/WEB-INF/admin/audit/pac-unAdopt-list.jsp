...
<div class="x-body">
    <%--<form class="layui-form x-center" action="${ctx}/admin/audit/unAdoptSearch" method="get" style="width:800px">
    ...
    <table class="layui-table">
        ...
        <c:if test="${audits.list.size()==0}">
            <tr><td colspan="10" style="text-align: center;color: #ccc">暂无数据</td></tr>
        </c:if>
        <c:if test="${audits.list.size()>0}">
                ...
                success:function(res){
                    if(res.msg=="ok"){
                        ...
                        if(res.audits.list.length<=0){
                            tr='<tr><td colspan="10" style="text-align: center;color: #ccc">暂无数据</td></tr>'
                        }else{
