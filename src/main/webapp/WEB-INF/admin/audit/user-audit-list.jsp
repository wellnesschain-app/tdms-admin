        ...
        <c:if test="${userAudits.list.size()>0}">
            <c:forEach items="${userAudits.list}" var="a">
                <tr>
                    ...
                    <td>
                        <a onclick="adopt(${a.id})" style="cursor:pointer;">通过</a>&nbsp|&nbsp<a onclick="reject(${a.id},'${a.uid}')" style="cursor:pointer;">驳回</a>
                    </td>
                </tr>
            </c:forEach>
        </c:if>
...
<script>
    layui.use(['laydate','element','laypage','layer'], function(){
        ...
        function getMemberList(curr) {
            $.ajax({
                url:"${ctx}/admin/audit/getUserAuditList",
                type:"GET",
                    ...
                    if(res.msg=="ok"){
                        ...
                        if(res.userAudits.list.length<=0){
                            ...
                            tr+='<tr><td>'+v.uid+'</td>'+
                                ...
                                '<td><a onclick="adopt('+v.id+')" style="cursor:pointer;">通过</a>&nbsp|&nbsp<a onclick="reject('+v.id+',\''+v.uid+'\')" style="cursor:pointer;">驳回</a></td></tr>';
                            })
                        }
