        ...
        <c:if test="${audits.list.size()>0}">
            <c:forEach items="${audits.list}" var="a">
                <tr>
                    ...
                    <td>
                        <u style="cursor:pointer" onclick="authens('身份证件照','${ctx}/admin/user/authenDetails?id=${a.uid}','1000','450')">
                        ${a.name}
                        </u>
                    </td>
                    <td>
                    ...
                    <td>
                        <a onclick="adopt(${a.id})" style="cursor:pointer;">通过</a>&nbsp|&nbsp<a onclick="reject(${a.id},'${a.fromAddr}')" style="cursor:pointer;">驳回</a>
                    </td>
                </tr>
            </c:forEach>
        </c:if>
                ...
                success:function(res){
                    if(res.msg=="ok"){
                        ...
                        if(res.audits.list.length<=0){
                            ...
                            tr+='<tr><td>'+v.uid +'</td><td>'+
                                '<u style="cursor:pointer" onclick="authens(\'身份证件照\',\'${ctx}/admin/user/authenDetails?id='+v.uid+'\',\'1000\',\'450\')">'+
                                name+ '</td><td>'+v.tel+'</td><td>'+
                                '<u style="cursor:pointer">'+v.fromAddr+'</u></td>'+
                                '<td><u style="cursor:pointer">'+v.toAddr+'</u></td>'+
                                '<td >'+v.fee+'</td><td>'+v.count+'</td><td>'+
                                    timeFormat(v.applicationTime)+ '</td><td>'+
                                    '<a onclick="adopt('+v.id+')" style="cursor:pointer;">通过</a>&nbsp|&nbsp<a onclick="reject('+v.id+'\',\''+v.fromAddr+'\')" style="cursor:pointer;">驳回</a>'+
                                '</td></tr>'
                            })
                        }
