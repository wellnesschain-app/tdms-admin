...
<script>
    layui.use(['laydate','element','laypage','layer'], function(){
        ...
        function getMemberList(curr) {
            $.ajax({
                url:"${ctx}/admin/transfer/getUSDTTransferList",
                type:"GET",
    ...
    function search() {
        ...
        if (addr == ""  && start_time == "" && end_time==""){
            alert("请输入查询条件")
            return false;
        }
        window.location.href="${ctx}/admin/transfer/toUSDTStreamSearch?start_time="+start_time+"&end_time="+end_time+"&addr="+addr;
    }
