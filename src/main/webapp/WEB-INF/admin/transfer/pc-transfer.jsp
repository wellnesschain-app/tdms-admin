...
<script>
    layui.use(['form','layer','layedit'], function(){
        ...
        form.on('submit(add)', function(data){
            ...
            //发异步，把数据提交给php
            $.get("${ctx}/admin/user/Editbalance",{id:id,balance:balance,useBalance:useBalance,ustdBalance:ustdBalance,level:level,addr:addr,username:username,remarks:remarks},function(res){
                if(res.msg=='ok'){
