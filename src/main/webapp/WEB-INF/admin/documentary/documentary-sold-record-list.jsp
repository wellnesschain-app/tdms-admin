...
<script>
    layui.use(['laydate','element','laypage','layer'], function(){
        ...
        function getMemberList(curr) {
            $.ajax({
                url:"${ctx}/admin/transfer/getTransferList",
                type:"GET",
                data:{"pageNum":curr,"pageSize":6},
                dataType:"json",
                    ...
                    if(res.msg=="ok"){
                        ...
                        if(res.transfers.list.length<=0){
                            ...
                            tr+='<tr><td><input type="checkbox" value="'+v.F01+'" name=""></td>'+
                                ...
                                '<td><u style="cursor:pointer">' +v.F04+'</u></td>' +
                                '<td >' +v.F05+'</td>' +
                                '<td>' +v.F07+'</td>' +
                                '<td>' +v.F06 +'</td></tr>'
                            })
    ...
    function search() {
        ...
        window.location.href="${ctx}/admin/documentary/toDocumentarySoldSearchList?start_time="+start_time+"&end_time="+end_time+"&id="+id;
    }
