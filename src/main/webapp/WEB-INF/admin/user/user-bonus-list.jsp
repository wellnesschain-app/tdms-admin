...
<div class="x-body">
    ...
    <xblock>共有数据：${user.total} 条</span></xblock>
        ...
        <c:if test="${user.list.size()>0}">
            <c:forEach items="${user.list}" var="w">
                <tr>
                    ...
                    <%--<td>
                        &lt;%&ndash;<a title="编辑" href="javascript:;" onclick="wealth_edit('编辑','${ctx}/admin/user/toEditbalance?addr='+'${w.addr}'+'&id='+${w.id},'900','380')"
                        ...
                        <a title="编辑" href="javascript:;" onclick="wealth_edit('编辑','${ctx}/admin/user/toEditbalance?addr='+'${w.addr}'+'&id='+${w.id},'900','380')"
                           class="ml-5" style="text-decoration:none">
                            ...
                            <a onclick="wealth_edit('资产信息','${ctx}/admin/user/toEditbalance?addr='+'${w.addr}'+'&id='+${w.id},'380','380')" style="cursor:pointer;">查看</a>&nbsp|&nbsp<a onclick="locking(${w.id})" style="cursor:pointer;">锁定</a>&nbsp|&nbsp<a onclick="unlock(${w.id})" style="cursor:pointer;">解锁</a>
    ...
    <input type="hidden" id="pages" value="${user.pages}">
    <div id="page"></div>
</div>
                    ...
                    if(res.msg=="ok"){
                        ...
                        if(res.wallets.list.length<=0){
                            ...
                            $.each(res.wallets.list,function (i, v) {
                                ...
                                '<td><a onclick="showContent('+v.id+',\''+v.addr+'\')" style="cursor:pointer;">查看</a>&nbsp|&nbsp<a onclick=" locking('+v.id+')" style="cursor:pointer;">锁定</a></td></tr>'
