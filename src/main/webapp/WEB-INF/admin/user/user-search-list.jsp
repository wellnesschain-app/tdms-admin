                    ...
                    <td>
                        <%--<a title="编辑" href="javascript:;" onclick="wealth_edit('编辑','${ctx}/admin/user/toEditbalance?addr='+'${w.addr}'+'&id='+${w.id},'900','380')"
                           class="ml-5" style="text-decoration:none">
                            ...
                            <a onclick="wealth_edit('资产信息','${ctx}/admin/user/toEditbalance?addr='+'${w.addr}'+'&id='+${w.id},'750','380')" style="cursor:pointer;">查看</a>&nbsp|&nbsp<a onclick="locking(${w.id})" style="cursor:pointer;">锁定</a>&nbsp|&nbsp<a onclick="unlock(${w.id})" style="cursor:pointer;">解锁</a>
...
<script>
    layui.use(['laydate','element','laypage','layer'], function(){
        ...
        function getMemberList(curr) {
            ...
            $.ajax({
                url:"${ctx}/admin/user/getUserSearchPage",
                type:"GET",
                data:{"pageNum":curr,"pageSize":10,"id":id,"account":account,"lock":lock,"start_time":start_time,"end_time":end_time},
                dataType:"json",
