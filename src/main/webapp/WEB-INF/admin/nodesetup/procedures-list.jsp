...
<div class="x-body">
    ...
    <xblock>共有数据：${procedures.total} 条</span></xblock>
    <table class="layui-table">
        ...
        <tbody id="tbody">
        <c:if test="${procedures.list.size()==0}">
            <tr><td colspan="7" style="text-align: center;color: #ccc">暂无数据</td></tr>
        </c:if>
        <c:if test="${procedures.list.size()>0}">
            <c:forEach items="${procedures.list}" var="w">
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <a title="编辑" href="javascript:;" onclick="wealth_edit('编辑','${ctx}/admin/nodeSetup/toEditProcedures?id='+${w.id},'700','430')"
    ...
    <input type="hidden" id="pages" value="${procedures.pages}">
    <div id="page"></div>
</div>
